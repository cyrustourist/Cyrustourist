...
///
/// این سرویس داده‌های مورد نیاز Home را از فهرست
/// اصلی TourismItem دریافت و دسته‌بندی می‌کند.
class HomeDataService {
  /// دریافت همه آیتم‌های معتبر برای صفحه اصلی.
  ...
  /// دریافت آیتم‌های پیشنهادی برای نمایش در Home.
  ///
  /// ترتیب اولویت:
  /// 1. جاذبه
  /// 2. اقامتگاه
