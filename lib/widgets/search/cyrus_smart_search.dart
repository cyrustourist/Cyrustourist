...
class _SearchTranslations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    ...
    'ja': {
      'title': 'スマート検索',
      'subtitle': 'すべての観光検索をひとつのスマート入口で',
      'searchHint': '何を探していますか？',
      'sectionGeneral': '一般検索',
      'sectionPlaces': '場所と体験',
      'sectionSmart': 'スマート検索',
      'quickSearch': 'クイック検索',
      'quickSearchSub': '観光コンテンツをすばやく検索',
      'cityProvince': '都市・州を検索',
      'cityProvinceSub': 'イランの都市と州を検索',
      'restaurant': 'レストラン・料理',
      'restaurantSub': 'レストランとグルメ体験',
      'cafe': 'カフェ検索',
      'cafeSub': 'カフェと休憩に適した場所',
      'shopping': 'ショッピングセンター・市場',
      'shoppingSub': '市場、モール、ローカルショッピング',
      'historical': '歴史・文化スポット',
      'historicalSub': '史跡、遺産、文化スポット',
      'nature': '自然・秘境',
      'natureSub': '森林、海、山、砂漠',
      'interests': '興味から検索',
      'interestsSub': 'あなたの興味に合った結果',
      'naturalLanguage': '自然言語検索',
      'naturalLanguageSub': '自然な文章で希望を入力',
      'aroundMe': '現在地周辺を検索',
      'aroundMeSub': '現在地の近くの観光スポット',
      'voice': '音声検索',
      'voiceSub': '音声で検索',
      'image': '画像検索',
      'imageSub': '写真から場所を検索 — 今後対応',
      'suggestions': 'スマート検索候補',
      'suggestionsSub': '検索中に関連候補を表示',
      'futureTitle': '近日公開',
      'futureMessage': '画像検索は今後のアップデートで提供予定です。',
      'close': '閉じる',
    },
  };
}
