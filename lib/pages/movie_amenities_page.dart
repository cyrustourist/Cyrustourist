...
import 'movie_video_page.dart' show MovieSlotData;

// رنگ‌ها — مطابق movie_video_page.dart (فایلی جدا، نمی‌تواند
...
/// صفحه‌ی «امکانات اقامتگاه/هتل/کلبه» برای فیلم‌ها — فهرست ثابتی از
/// امکانات که هنگام تکمیل مشخصات هر جایگاه تیک زده می‌شوند و اینجا
/// برای گردشگر نمایش داده می‌شوند. تا وقتی مقدار واقعی وارد نشده،
/// همه‌ی موارد به‌صورت «ندارد/نامشخص» نمایش داده می‌شوند.
class MovieAmenitiesPage extends StatelessWidget {
  const MovieAmenitiesPage({super.key, required this.data});
  ...
  List<_AmenityRow> get _rows => [
        ...
        _AmenityRow(
          ...
          label:
              _t('مناسب حیوان خانگی', 'Pet-friendly', 'يسمح بالحيوانات الأليفة'),
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text(
            _t('امکانات اقامتگاه/هتل/کلبه', 'Residence / Hotel / Cabin Amenities',
        ...
        body: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              Text(
                _t(
                  'این فهرست، امکانات ثابتی است که هنگام تکمیل مشخصات این جایگاه تیک زده می‌شوند.',
                  'This is the fixed list of amenities ticked once this slot’s details are completed.',
                  'هذه قائمة المرافق الثابتة التي يتم تحديدها عند استكمال بيانات هذا المكان.',
                ),
                style: TextStyle(
