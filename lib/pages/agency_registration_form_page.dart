...
/// «درخواست ثبت‌نام آژانس» — فقط ارسال درخواست به پشتیبانی؛
/// ثبت‌نام نهایی و فعال‌سازی فقط توسط مدیریت انجام می‌شود.
class AgencyRegistrationFormPage extends StatefulWidget {
  const AgencyRegistrationFormPage({super.key});

  @override
  State<AgencyRegistrationFormPage> createState() =>
      _AgencyRegistrationFormPageState();
}

class _AgencyRegistrationFormPageState extends State<AgencyRegistrationFormPage> {
  ...
  String _buildMessage() {
    return 'درخواست ثبت‌نام آژانس — CYRUS TOURIST\n\n'
        'نام آژانس: ${_nameCtrl.text.trim()}\n'
        'شماره تماس: ${_phoneCtrl.text.trim()}\n'
        'شهر محل فعالیت: ${_cityCtrl.text.trim()}\n'
        'خدمات ارائه‌شده: ${_servicesCtrl.text.trim()}\n'
    ...
    showDialog(
      ...
      builder: (_) => Directionality(
        ...
        child: AlertDialog(
          ...
          content: const Text(
            'درخواست شما با موفقیت دریافت شد. اطلاعات آژانس شما توسط مدیریت CYRUS TOURIST '
            ...
            child: ListView(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: _decoration('نام آژانس'),
                ...
                TextFormField(
                  ...
                  style: const TextStyle(color: Colors.white),
                  decoration: _decoration('خدمات ارائه‌شده', hint: 'مثلاً: تور خارجی، بلیط، اقامتگاه...'),
                  validator: (v) => (v == null || v.trim().isEmpty) ? 'وارد کنید' : null,
                ),
                const SizedBox(height: 14),
